...
public class Events {
    ...
    public void OnChat(ClientChatReceivedEvent event) throws InterruptedException, IOException {
        ...
        write.println("<section class=\"Content\">" + "<p class=\"Day\">" + FunctionModule.GetData("Day",Message) + "</p>" + "<p class=\"Time\">" + FunctionModule.GetData("Time",Message) + "</p>" + "<p class=\"PlayerName\">" + FunctionModule.GetData("Name",Message) + "</p>" + "<p class=\"Message\">" + FunctionModule.GetData("Message",Message) + "</p>" + "</section>");
        write.flush();
    }
}
